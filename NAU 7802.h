/*
  ...
  Modified and ported to STM32 using HAL by Mussab Mehboob
  Copyright (c) 2023 Yasir Shahzad (mussabmehboob312@gmail.com)

  Original Arduino library:
  https://github.com/sparkfun/SparkFun_NAU7802_Scale_Arduino_Library
*/

#ifndef NAU7802_STM32_HAL_Driver_h
#define NAU7802_STM32_HAL_Driver_h
...
public:
  ...
  bool begin(I2C_HandleTypeDef *hi2c, bool reset = true); //Check communication and initialize sensor
  ...
  float getWeight(bool allowNegativeWeights = true, uint8_t samplesToTake = 8, unsigned long timeout_ms = 1000); //Once you've set zero offset and cal factor, you can ask the library to do the calculations for you.
